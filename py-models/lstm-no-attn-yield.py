...
def main():
    ...
    for year in all_years:
        ...
        y_val_tensor = torch.tensor(y_val['yield'].values, dtype=torch.float32).unsqueeze(1).to(device)
        ...
        performance_report(y_df.loc[mask, 'pred'].values, y_df.loc[mask, 'yield'].values)
    ...
    final_df.to_csv("plots_data/lstm_no_attn_2000_2005_detrend_regression.csv", index=False)
    ...
    plt.savefig("plots_data/lstm_no_attn_2000_2005_detrend_regression.png")  
