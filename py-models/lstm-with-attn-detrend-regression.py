...
def main():
    ...
    final_df.to_csv("plots_data/lstm_with_attn_2000_2005_detrend_regression.csv", index=False)
    ...
    plt.savefig("plots_data/lstm_with_attn_2000_2005_detrend_regression.png")  
